...
export default function StoreDetailScreen() {
  ...
  const openWhatsApp = () => {
    ...
    const phone = store.acteur.whatsAppActeur
      .replace(/\s+/g, "")
      .replace("+", "");
        ...
        return (
          <View className="grid grid-cols-2 gap-3 mt-4">
            ...
            {products.length === 0 && !loading && (
              <Text className="text-center text-gray-500 py-8 col-span-2">
              ...
              <View className="space-y-4">
                ...
                <View className="flex-row items-center gap-3 p-3 bg-gradient-to-r from-purple-50 to-purple-100/50 rounded-xl">
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-gray-800 font-medium">
                      {store.niveau1Pays?.nomN1 || "Non spécifiée"}
                    </Text>
                  </View>
                </View>
              ...
              <View className="bg-white rounded-2xl p-4 shadow-lg border border-gray-100">
                ...
                <View className="flex-row items-center gap-4 mb-6 p-3 bg-gradient-to-r from-indigo-50 to-purple-50/50 rounded-xl">
                  <Image
                    source={{
                      uri:
                        store.acteur.photoSiegeActeur ||
                        store.acteur.logoActeur ||
                        "https://via.placeholder.com/80/079C48/FFFFFF?text=" +
                          store.acteur.nomActeur.charAt(0),
                    }}
                  ...
                  <View className="flex-1">
                    ...
                    <Text className="text-gray-500 text-sm">
                      {store.acteur.emailActeur}
                    </Text>
                  </View>
                </View>

                {/* Tags de spécialisation */}
                {store.acteur.typeActeur &&
                  store.acteur.typeActeur.length > 0 && (
                    <View className="mb-4">
                ...
                {store.acteur.speculation &&
                  store.acteur.speculation.length > 0 && (
                    <View>
                      <Text className="text-gray-600 text-sm font-medium mb-3">
                          ...
                          >
                            ...
                            <View className="flex-1">
                              ...
                              <Text
                                ...
                                numberOfLines={1}
                              >
                                {spec.descriptionSpeculation ||
                                  "Spécialisation en " + spec.nomSpeculation}
                              </Text>
                            </View>
                          </View>
                        ))}
                ...
                {store.acteur.whatsAppActeur && (
                  <TouchableOpacity
                    ...
                    className="mt-4 bg-gradient-to-r from-green-500 to-emerald-400 p-4 rounded-xl flex-row items-center justify-between shadow-md active:opacity-90"
                  >
                    <View className="flex-row items-center gap-3">
                      ...
                      <View>
                        ...
                        <Text className="text-gray-800/80 text-xs">
                          {store.acteur.whatsAppActeur}
                        </Text>
                      </View>
                    </View>
                  ...
                  <View className="flex-row items-center gap-2">
                    <View
                      className={`w-3 h-3 rounded-full ${
                        store.statutMagasin ? "bg-green-500" : "bg-gray-400"
                      }`}
                    />
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="relative">
          <Image
            source={{
              uri:
                store.photo ||
                "https://via.placeholder.com/400x200/22C55E/FFFFFF?text=Magasin",
            }}
                ...
                store.acteur.typeActeur.length > 0 && (
                  <Badge variant="secondary" className="bg-orange-500">
                    <Text className="text-white text-xs">
                      {store.acteur.typeActeur[0].libelle}
                    </Text>
                  </Badge>
                )}
            </View>
        ...
        <View className="px-4 mt-4 space-y-3">
          <View className="flex-row items-center gap-2">
            ...
            <Text className="text-gray-800 text-sm">
              {store.localiteMagasin}, {store.niveau1Pays?.nomN1}
            </Text>
          </View>
        ...
        <View className="px-4 mt-4 flex-row gap-3">
          <TouchableOpacity
            onPress={openPhone}
            className="flex-1 border border-primary bg-primary py-3 rounded-xl items-center flex-row justify-center gap-2"
          >
          ...
          <TouchableOpacity
            onPress={openWhatsApp}
            className="flex-1 border border-primary py-3 rounded-xl items-center flex-row justify-center gap-2"
          >
