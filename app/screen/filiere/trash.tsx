        ...
        <View className="bg-white px-4 pt-4 pb-6">
          <View className="flex-row items-start justify-between mb-4">
            <View className="flex-1">
              ...
              {currentFiliere?.descriptionFiliere &&
                currentFiliere.descriptionFiliere !== "string" && (
                  <Text className="text-gray-600 text-sm">
                    {currentFiliere.descriptionFiliere}
                  </Text>
                )}
              {currentFiliere?.codeFiliere && (
                <Text className="text-gray-500 text-xs mt-1">
                  Code: {currentFiliere.codeFiliere}
                </Text>
              )}
            </View>
          ...
          <View className="flex-row justify-between bg-gray-50 rounded-xl p-3">
            ...
            <View className="items-center flex-1 border-l border-r border-gray-200">
              ...
              <Text className="text-gray-500 text-xs">Magasins</Text>
            </View>
            <View className="items-center flex-1">
              <Text className="text-lg font-bold text-gray-900">
                {Math.round(stats.averagePrice).toLocaleString()} F
              </Text>
              <Text className="text-gray-500 text-xs">Prix moyen</Text>
            </View>
          </View>
        </View>
            ...
            <View className="flex-row justify-between">
              <View className="items-center">
                <Text className="text-green-600 font-bold text-lg">
                  {Math.round(stats.minPrice).toLocaleString()} F
                </Text>
                <Text className="text-gray-500 text-xs">Prix minimum</Text>
              </View>
              <View className="items-center">
              ...
              <View className="items-center">
                <Text className="text-yellow-600 font-bold text-lg">
                  {Math.round(stats.maxPrice).toLocaleString()} F
                </Text>
                <Text className="text-gray-500 text-xs">Prix maximum</Text>
              </View>
            </View>
          </View>
        )}
