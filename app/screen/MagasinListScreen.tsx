...
export default function MagasinListScreen() {
    ...
    const { magasins, loadingMagasins, errorMagasins, getAllMagasins } = useHome();
        ...
        >
            ...
            <View className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <View className="relative h-36">
                    <Image
                        source={{ uri: magasin.photo || 'https://via.placeholder.com/200x150/079C48/FFFFFF?text=Magasin' }}
        ...
        >
            <View className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
                <View className="flex-row items-center">
                    {/* Image */}
                    <Image
                        source={{ uri: magasin.photo || 'https://via.placeholder.com/80/079C48/FFFFFF?text=' + magasin.nomMagasin.charAt(0) }}
                ...
                <View className="flex-row items-center justify-between mb-3">
                    ...
                    <View className="flex-row items-center gap-2">
                        <TouchableOpacity
                            ...
                            className={`p-2 rounded-xl ${viewMode === 'grid' ? 'bg-primary/10' : ''}`}
                        >
                            <Grid3x3 size={20} color={viewMode === 'grid' ? '#079C48' : '#64748B'} />
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => setViewMode('list')}
                            className={`p-2 rounded-xl ${viewMode === 'list' ? 'bg-primary/10' : ''}`}
                        >
                            <List size={20} color={viewMode === 'list' ? '#079C48' : '#64748B'} />
                        </TouchableOpacity>
                    </View>
                </View>
                    ...
                    <View className="flex-1 items-center justify-center p-8">
                        <View className="items-center">
                            ...
                            {searchQuery && (
                                ...
                                >
                                    <Text className="text-white font-medium">Voir tous les magasins</Text>
                                </TouchableOpacity>
                            )}
                        </View>
                    </View>
